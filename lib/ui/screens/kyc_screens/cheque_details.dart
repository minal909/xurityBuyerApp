...
class _ChequeDetailsState extends State<ChequeDetails> {
  ...
  Future init() async {
    ...
    Cheque Docdetails = Cheque.fromJson(details['chequeImages']);
    setState(() {
      List<String> imgfiles = Docdetails.files;
      this.imgfiles = imgfiles;
    });
    print('Cheque files...))))))))))))${imgfiles[0].toString()}');
  }
                      ...
                      child: ListView(children: [
                        ...
                        Padding(
                          padding: EdgeInsets.only(
                              ...
                              bottom: h1p * 3),
                          child: Text(
                            "NOTE: Please provide security cheque where account number should be clearly visible\n\n",
                        ...
                        DocumentUploading(
                          ...
                          maxHeight: maxHeight,
                          flag: true,
                          shouldPickFile: chequeImages?.isEmpty ?? true,
                        ...
                        SelectedImageWidget(documentImages: chequeImages),
                        InkWell(
                          onTap: () async {
                            if (chequeImages?.isNotEmpty ?? false) {
                              progress?.show();
                              Map<String, dynamic> chequeImagesMap =
                                  await getIt<KycManager>().chequeImages(
